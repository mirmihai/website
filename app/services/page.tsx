...
export default function ServicesPage() {
  ...
  // Notice we use iconNode instead of Icon to prevent Server-to-Client serialization errors
  const services = [
    {
      iconNode: (
        ...
        <div className="max-w-4xl mx-auto text-center">
          <ScrollReveal>
            ...
            <p className="text-lg text-slate-400 leading-relaxed mb-6">
              Maintaining a home takes time, effort, and a wide variety of
              skills. Instead of calling a separate local painter, carpenter,
              and repairman, Prime Build Construction offers a complete,
              all-in-one building and maintenance solution tailored to the
              Ireland market.
            </p>
            <p className="text-lg text-slate-400 leading-relaxed">
              We pride ourselves on doing the job right the first time. Whether
              we are completing a full interior painting project in South
              Ireland or working through a monthly property maintenance
              checklist in North Ireland, we bring professional-grade equipment,
              premium materials, and a meticulous eye for detail to every
              property we enter. Explore our core services below.
            </p>
          </ScrollReveal>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center relative z-10">
          <ScrollReveal>
            ...
            <p className="text-lg text-slate-400 mb-10 max-w-2xl leading-relaxed">
              ...
              Ireland, just give us a call. We&apos;re happy to discuss how we
